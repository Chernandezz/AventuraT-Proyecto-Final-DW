...
INSERT INTO `productos` (`id`, `titulo`, `precio`, `imagen`, `descripcion`, `cantidad`)
        VALUES (1, 'Cuerda de Rappel', '56000.00', 'd6f2e980df6885ce7954b496ce4957b2.png', 'Lo mejor de lo mejor', 2);
-- --------------------------------------------------------
--
...
CREATE TABLE `usuarios` (
    ...
    `imagen` varchar(200) DEFAULT NULL) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
ALTER TABLE `paquetes` MODIFY `id` int (11) NOT NULL AUTO_INCREMENT;
